...
import {  ItemMenuMobiles } from "./items-menu-mobile"
 ...
 const  Navbar =() =>{
      ...
      return (
            <div className="flex items-center justify-between p-4 mx-auto cursor-pointer sm:max-w-4xl md:max-w-6xl">
             <h1 className="text-3xl" onClick={()=> router.push("/")}> Arango
             ...
             <div className="flex items-center justify-between gap-2 sm:ga">
               {cart.items.length ===0 ?
